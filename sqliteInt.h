...
#define WHERE_ORDERBY_LIMIT    0x4000 /* ORDERBY+LIMIT on the inner loop */
...
/* COMDB2 MODIFICATION */
Select *sqlite3SelectNewv(Parse*,ExprList*,SrcList*,Expr*,ExprList*,
                         Expr*,ExprList*,u16,Expr*,Expr*);
...
/* COMDB2 MODIFICATION */
extern int sqlite3IsTempTable(int rootpage);

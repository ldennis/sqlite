# Local defs
SQLITE_MEMGEN:=sqlite/mem_sqlite.c
SQLITE_MEMGENOBJ:=$(SQLITE_MEMGEN:.c=.o)
SQLITE_OBJS:=sqlite/analyze.o sqlite/attach.o sqlite/auth.o		\
	 ...
	 sqlite/comdb2vdbe.o $(SQLITE_MEMGENOBJ)
...
SQLITE_OBJS_EXT:=sqlite/ext/comdb2systbl/tables.o \
sqlite/ext/comdb2systbl/columns.o         \
sqlite/ext/comdb2systbl/keys.o            \
sqlite/ext/comdb2systbl/keycomponents.o   \
sqlite/ext/comdb2systbl/constraints.o     \
sqlite/ext/comdb2systbl/tablesizes.o      \
sqlite/ext/comdb2systbl/procedures.o      \
sqlite/ext/comdb2systbl/users.o           \
sqlite/ext/comdb2systbl/tablepermissions.o
...
sqlite_CPPFLAGS+=-Isqlite -Isqlite/inline -Isqlite/ext/comdb2systbl	\
-Idatetime -Idfp/decNumber -Idfp/dfpal -Icsc2 -Icdb2api			\
-Ischemachange -Ibdb -Inet -Iprotobuf -Idlmalloc -Ilua -Idb		\
$(OPTBBINCLUDE)
...
GENC+=$(SQLITE_MEMGEN) $(SQLITE_GENC)
GENH+=$(SQLITE_MEMGEN:.c=.h) $(SQLITE_GENH)
...
sqlite/parse.c: protobuf/sqlquery.pb-c.c protobuf/bpfunc.pb-c.c db/mem_uncategorized.c

...
/* COMDB2 MODIFICATION */
SQLITE_API int SQLITE_STDCALL sqlite3_bind_datetime(sqlite3_stmt *pStmt, int i, dttz_t *, char *tz);
SQLITE_API int SQLITE_STDCALL sqlite3_bind_interval(sqlite3_stmt *pStmt, int i, intv_t it);
...
SQLITE_API sqlite3_value *SQLITE_STDCALL sqlite3_column_value(sqlite3_stmt*, int iCol);
 /* COMDB2 MODIFICATION */
SQLITE_API int SQLITE_STDCALL sqlite3_hasNColumns(sqlite3_stmt*, int iCol);
SQLITE_API int SQLITE_STDCALL sqlite3_isColumnNullType(sqlite3_stmt*, int iCol);
